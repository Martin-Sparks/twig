...
const x = import("../components/groupArrayElements");

import groupArrayElements from "../components/groupArrayElements";

describe("groupArrayElements", () => {
  it.only("should return 3 arrays of length 4, with no remainder", () => {
